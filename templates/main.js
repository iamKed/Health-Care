...
passwordInput.onkeyup = function () {
    ...
    if (passVal != "") {
        if (whiteSpace) {
            passwordInfo.textContent = "White spaces are not allowed";
        }
        else {
        ...
        passwordInfo.textContent = "Please enter your password";
    }
...
function weakPasswordStrength(passLen, poorPassword, weakPassword, strongPassword) {
    ...
    if (passLen >= 6 && poorPassword && (weakPassword || strongPassword)) {
        ...
        passwordInfo.textContent = "your password is Weak: Use Special symbol and digits";

    } else {
        passwordInfo.textContent = "Use Special symbol and length will be atleast 8";
    }
}
...
function checkIt() {
    var cfpw = document.getElementById("id_password2");
    var pw = document.getElementById("id_password1");
    if (cfpw.value != pw.value) {
